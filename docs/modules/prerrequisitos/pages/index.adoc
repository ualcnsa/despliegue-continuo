...
1. Accede a la página oficial de Azure para Estudiantes: https://   .microsoft.com/free/students/.
2. Haz clic en el botón *Activar ahora* y sigue las instrucciones para registrarte con tu cuenta educativa __@inlumine.ual.es__.
3. Una vez activada la suscripción, tendrás acceso a $100 USD en crédito durante 12 meses y a servicios gratuitos como máquinas virtuales, bases de datos y más.
